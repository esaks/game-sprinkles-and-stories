...
raw_cafe_bg = pygame.image.load('Original-itchio-assets/Cafe Backgrounds_021325/Cafe_Interior.jpg')
...
# Counter
counter, counter_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Background/counter.png', .5)
counter_rect.bottomleft = (0, 500) 
# Stove
stove, stove_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Counter/stove.png', .5)
stove_rect.bottomleft = (700, 500)
# Bread box
bread_box, bread_box_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Counter/basket_1.png', .5)
bread_box_rect.bottomleft = (550, 450)
# Cupcake stand
cupcake_stand, cupcake_stand_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Shelf/cheese_stand.png', .5)
cupcake_stand_rect.bottomleft = (480, 420)
# Bowls
bowls, bowls_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Shelf/bowls.png', .5)
bowls_rect.bottomleft = (100, 410)
# Sugar 
sugar, sugar_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Counter/sugar_bowl.png', .5)
sugar_rect.bottomleft = (650, 470)
# Flowers
flowers, flowers_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Shelf/bottom_flowers.png', .5)
flowers_rect.bottomleft = (15, 430)
# Butter (made up of three images together)
class ButterDish:
    def __init__(self):
        self.butter_base, self.butter_base_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Shelf/butter_base.png', .5)
        self.butter, self.butter_rect =  img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Shelf/butter.png', .5)
        self.butter_glass, self.butter_glass_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Shelf/butter_glass.png', .5)
...
white_frosting_bowl = FrostingBowl(
    'Original-itchio-assets/Sprites/Sprites/Environment/Shelf/blueberry_bowl.png',
    'Original-itchio-assets/assets/sweets/vanilla_cupcake.png',
    pos = (620, 470),
    color= "white"
)
...
# Sprinkle shakers
white_sprinkle_shaker, white_sprinkle_shaker_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Counter/salt.png', .5)
white_sprinkle_shaker_rect.bottomleft = (40, 470)

blue_sprinkle_shaker, blue_sprinkle_shaker_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Counter/salt.png', .5)
blue_sprinkle_shaker_rect.bottomleft = (80, 470)
blue_sprinkle_shaker = tint_image(blue_sprinkle_shaker, color="slategray2")

pink_sprinkle_shaker, pink_sprinkle_shaker_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Counter/salt.png', .5)
pink_sprinkle_shaker_rect.bottomleft = (120, 470)
pink_sprinkle_shaker = tint_image(pink_sprinkle_shaker, color="palevioletred2")

brown_sprinkle_shaker, brown_sprinkle_shaker_rect = img_load_with_scale('Original-itchio-assets/Sprites/Sprites/Environment/Counter/salt.png', .5)
...
white_frosting_img, white_frosting_rect = img_load_with_scale("sprinkles-and-sprites/frosting_white.png", .5)
blue_frosting_img, blue_frosting_rect = img_load_with_scale("sprinkles-and-sprites/frosting_blue.png", .5)
pink_frosting_img, pink_frosting_rect = img_load_with_scale("sprinkles-and-sprites/frosting_pink.png", .5)
brown_frosting_img, brown_frosting_rect = img_load_with_scale("sprinkles-and-sprites/frosting_brown.png", .5)
frostings = {
...
white_sprinkles_img, white_sprinkles_rect = img_load_with_scale("sprinkles-and-sprites/sprinkles_white.png", .25)
blue_sprinkles_img, blue_sprinkles_rect = img_load_with_scale("sprinkles-and-sprites/sprinkles_blue.png", .25)
blue_sprinkles_img.set_colorkey((255, 255, 255)) # make pure white transparent
pink_sprinkles_img, pink_sprinkles_rect = img_load_with_scale("sprinkles-and-sprites/sprinkles_pink.png", .25)
pink_sprinkles_img.set_colorkey((255, 255, 255))
brown_sprinkles_img, brown_sprinkles_rect = img_load_with_scale("sprinkles-and-sprites/sprinkles_brown.png", .25)
...
class BakingCupcake(): 
    def __init__(self, frosting=None, sprinkles=None):
        self.cupcake, self.cupcake_rect = img_load_with_scale('sprinkles-and-sprites/muffin_edited.png', .5) # edited original image to have a blue wrapper
...
# Customer spawner
customer_templates = [
    {"name": "Zoe", "sprite": "Original-itchio-assets/Budget-Characters/16f.png", "scale_fac": 0.2,  "fav_frosting": "white", "fav_sprinkles": "blue", "traits": ["neurotic","extroverted"], "spawn_weight": .10},
    {"name": "Marcus", "sprite": "Original-itchio-assets/Budget-Characters/16m.png", "scale_fac": 0.2,  "fav_frosting": "brown", "fav_sprinkles": "brown", "traits": ["introverted", "awkward"], "spawn_weight": .10},
    {"name": "Justin", "sprite": "Original-itchio-assets/Budget-Characters/16mb.png", "scale_fac": 0.2, "fav_frosting": "brown", "fav_sprinkles": "blue", "traits": ["relaxed", "cool"], "spawn_weight": .10},
    {"name": "Crystal", "sprite": "Original-itchio-assets/Budget-Characters/19fb.png", "scale_fac": 0.2,  "fav_frosting": "blue", "fav_sprinkles": "pink", "traits": ["cool", "closed"], "spawn_weight": .10},
    {"name": "Michael", "sprite": "Original-itchio-assets/Budget-Characters/19m.png", "scale_fac": 0.2,  "fav_frosting": "blue", "fav_sprinkles": "None", "traits": ["introverted", "sensitive"], "spawn_weight": .10},
    {"name": "Samantha", "sprite": "Original-itchio-assets/Budget-Characters/22f.png", "scale_fac": 0.2,  "fav_frosting": "white", "fav_sprinkles": "pink", "traits": ["relaxed", "sensitive"], "spawn_weight": .10},
    {"name": "Ted", "sprite": "Original-itchio-assets/Budget-Characters/22m.png", "scale_fac": 0.2,  "fav_frosting": "white", "fav_sprinkles": "brown", "traits":["blunt", "awkward"], "spawn_weight": .10},
    {"name": "Joyce", "sprite": "Original-itchio-assets/Budget-Characters/banker-f.png", "scale_fac": 0.2,  "fav_frosting": "pink", "fav_sprinkles": "white", "traits":["sensitive", "open"], "spawn_weight": .10},
    {"name": "Arthur", "sprite": "Original-itchio-assets/Budget-Characters/banker-m.png", "scale_fac": 0.2,  "fav_frosting": "white", "fav_sprinkles": None, "traits": ["extroverted", "open"], "spawn_weight": .10},
    {"name": "Diana", "sprite": "Original-itchio-assets/Budget-Characters/mom.png", "scale_fac": 0.2,  "fav_frosting": "pink", "fav_sprinkles": None, "traits":["blunt", "open"], "spawn_weight": .10}
]
# Traits explained:
...
while running: #shorthand for while running==TRUE. This is the game loop.
    ...
    if game_state == "reacting":
        ...
        if order_reaction_timer >= reaction_duration: 
            active_customer1.visits +=1 # increment visits
            #print("Visits:", active_customer1.visits)
    ...
    if game_state == "waiting":  
        ...
        if customer_wait >= wait_time:
            ...
            met_stage_requirement = dialogue_manager.can_trigger_progression(active_customer1) # determine if customer has the right stats to trigger the next story stage event

            if met_stage_requirement == True:
                # If has not met customer, automatically trigger introduction event
                if active_customer1.story_stage == 0:
                    current_visit_type = "progression"
                ...
                # Determine visit type
                    ...
                    if current_visit_type == "progression":
                        ...
                        game_state = "progression_event"
                        dialogue_tracker.start_dialogue(active_customer1)
                    elif current_visit_type == "regular":
                        game_state = "ordering"
                        ...
                        if prog_dialogue_box.collidepoint(event.pos):
                            if  not dialogue_tracker.showing_choices: #text not prompt
                                if dialogue_tracker.current_phase == "reactions":
                                    ...
                                    active_customer1.story_stage += 1 # increment story stage after completing progression event
                                    active_customer1.spawn_weight = relationship_manager.update_spawn_weight(active_customer1, dialogue_tracker) #update spawn weight after progression event
                                    #print("Stage:", active_customer1.story_stage, "Weight:", active_customer1.spawn_weight)
                        ...
                        if dialogue_tracker.showing_choices:
                            for rect, key, text in dialogue_tracker.response_rects:
                                if rect.collidepoint(event.pos):
                                    ...
                                    active_customer1.friendship = relationship_manager.update_friendship(active_customer1, dialogue_tracker)
                                    #print("Friendship:", active_customer1.friendship)
                ...
                if is_dragging == True:
                    ...
                    if active_cupcake.cupcake_rect.colliderect(active_customer1.img_rect):
                        ...
                        if finished_cupcake == active_customer1.order:
                            ...
                            active_customer1.friendship += 2
                            #print("Friendship after order correct:", active_customer1.friendship)
                            game_state = "reacting"
                            order_reaction_timer = 0
                            ...
                            game_state = "reacting" 
                            order_reaction_timer = 0
                            #print("Friendship after order incorrect:", active_customer1.friendship)
    ...
    if game_state == "progression_event":
        ...
        if dialogue_tracker.showing_choices == True:    
            for rect, key, text in dialogue_tracker.response_rects:
                #pygame.draw.rect(screen, "red", rect, 2) - for debugging draw box outlines
                pygame.draw.rect(screen, "burlywood", rect)
                y = rect.y + 2.5
                for line in text: 
                    surf=responses_font.render(line, True, "antiquewhite1")
                    screen.blit(surf, (rect.x + 10, y))
                    y += dialogue_manager.line_height # must match
